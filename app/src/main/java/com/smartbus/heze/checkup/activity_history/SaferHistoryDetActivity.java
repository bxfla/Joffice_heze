...
import com.smartbus.heze.checkup.presenter.SaferHistoryItemPresenter;
...
public class SaferHistoryDetActivity extends BaseActivity implements SaferHistoryItemContract.View {
    ...
    String workId = "";
    SaferHistory.ResultBean bean;
    BaseRecyclerAdapter baseRecyclerAdapter;
    List<CarCheckHistoryItem.ResultBean> beanList = new ArrayList<>();
    SaferHistoryItemPresenter saferHistoryItemPresenter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        ButterKnife.bind(this);
        bean = (SaferHistory.ResultBean) getIntent().getSerializableExtra("bean");
        ...
        saferHistoryItemPresenter = new SaferHistoryItemPresenter(this, this);
        saferHistoryItemPresenter.getSaferHistoryItem(workId);
    }
    ...
    @Override
    public void setSaferHistoryItem(CarCheckHistoryItem s) {
    ...
    @Override
    public void setSaferHistoryItemMessage(String s) {
