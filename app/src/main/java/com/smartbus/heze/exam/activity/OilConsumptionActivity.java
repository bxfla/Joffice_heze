...
import com.smartbus.heze.exam.presenter.OilConsunptionPresenter;
...
public class OilConsumptionActivity extends BaseActivity implements OilConsumptionContract.View {
    ...
    OilConsunptionPresenter oilConsunptionPresenter;
    List<OilConsumption.ResultBean> beanList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oilConsunptionPresenter = new OilConsunptionPresenter(this, this);
        oilConsunptionPresenter.getOilConsumption(tvStartTime.getText().toString()
    ...
    @Override
    public void setOilConsumption(OilConsumption s) {
        ...
        baseRecyclerAdapter = new BaseRecyclerAdapter<OilConsumption.ResultBean>(this, R.layout.adapter_oil_item, beanList) {
            @Override
            public void convert(BaseViewHolder holder, final OilConsumption.ResultBean resultBean) {
                ...
                holder.setText(R.id.tvType, resultBean.getFuelType());
                holder.setText(R.id.tvUser, resultBean.getBaiglxh()+"");
    ...
    @Override
    public void setOilConsumptionMessage(String s) {
