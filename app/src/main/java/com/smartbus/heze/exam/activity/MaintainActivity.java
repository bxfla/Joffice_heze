...
import com.smartbus.heze.exam.presenter.MaintainPresenter;
...
public class MaintainActivity extends BaseActivity implements MaintainContract.View {
    ...
    MaintainPresenter maintainPresenter;
    List<Maintain.ResultBean> beanList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maintainPresenter = new MaintainPresenter(this, this);
        maintainPresenter.getMaintain(tvStartTime.getText().toString()
    ...
    @Override
    public void setMaintain(Maintain s) {
        ...
        baseRecyclerAdapter = new BaseRecyclerAdapter<Maintain.ResultBean>(this, R.layout.adapter_maintain_item, beanList) {
            @Override
            public void convert(BaseViewHolder holder, final Maintain.ResultBean resultBean) {
                holder.setText(R.id.tvDate, resultBean.getCreateDate());
                holder.setText(R.id.tvCarNo, resultBean.getCarNo());
                holder.setText(R.id.tvMaintainCode, resultBean.getBustypeCode());
                holder.setOnClickListener(R.id.ll, new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(MaintainActivity.this,MaintainDetailActivity.class);
    ...
    @Override
    public void setMaintainMessage(String s) {
