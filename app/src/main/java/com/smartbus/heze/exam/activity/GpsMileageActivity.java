...
import com.smartbus.heze.exam.presenter.GpsMileagePresenter;
 ...
 * GPS里程
 */
public class GpsMileageActivity extends BaseActivity implements GpsMileageContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gpsMileagePresenter = new GpsMileagePresenter(this, this);
        gpsMileagePresenter.getGpsMileage(tvStartTime.getText().toString()
    ...
    public void setGpsMileage(GPSMileage s) {
        ...
        baseRecyclerAdapter = new BaseRecyclerAdapter<GPSMileage.ResultBean>(this, R.layout.adapter_gpsmileage_item, beanList) {
            @Override
            public void convert(BaseViewHolder holder, final GPSMileage.ResultBean resultBean) {
                holder.setText(R.id.tvDate, resultBean.getGps_sfclc());
                holder.setText(R.id.tvLine, resultBean.getXlbh());
                holder.setText(R.id.tvCarNo, resultBean.getCh());
                holder.setText(R.id.tvWXLC, resultBean.getGps_wxlc());
                holder.setText(R.id.tvFYYLC, resultBean.getGps_fyylc());
                holder.setText(R.id.tvLCYY, resultBean.getGps_yylc());
                holder.setText(R.id.tvZLC, resultBean.getGps_zlc());
            }
        };
    ...
    @Override
    public void setGpsMileageMessage(String s) {
