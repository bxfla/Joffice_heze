...
public class SimulateAdapter extends PagerAdapter {
    ...
    public SimulateAdapter(SimulateActivity context, List<View> viewItems, List<ExaminationData.DataBean> beanList) {
        mContext = context;
