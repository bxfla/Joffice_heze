...
import com.smartbus.heze.fileapprove.module.CheckTypeLRContract;
...
public class CheckTypeLZPresenter implements CheckTypeLRContract.presenter {

    private Context context;
    private CheckTypeLRContract.View view;

    public CheckTypeLZPresenter(Context context, CheckTypeLRContract.View view) {
